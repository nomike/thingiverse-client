...
if TYPE_CHECKING:
    from ..models.file_meta_data_item import FileMetaDataItem
...
class File:
    ...
    Attributes:
        ...
        meta_data (list[FileMetaDataItem] | Unset):
    ...
    id: int | Unset = UNSET
    meta_data: list[FileMetaDataItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _meta_data is not UNSET:
            ...
            for meta_data_item_data in _meta_data:
                meta_data_item = FileMetaDataItem.from_dict(meta_data_item_data)
