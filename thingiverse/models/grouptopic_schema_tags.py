...
T = TypeVar("T", bound="GrouptopicSchemaTags")


@_attrs_define
class GrouptopicSchemaTags:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grouptopic_schema_tags.additional_properties = d
        return grouptopic_schema_tags
