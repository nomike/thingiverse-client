...
class CopySchema:
    ...
    Attributes:
        ...
        details_parts (list[CopySchemaDetailsPartsItem] | Unset):
    ...
    details_parts: list[CopySchemaDetailsPartsItem] | Unset = UNSET
    id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _details_parts is not UNSET:
            ...
            for details_parts_item_data in _details_parts:
                details_parts_item = CopySchemaDetailsPartsItem.from_dict(details_parts_item_data)
        ...
        copy_schema.additional_properties = d
        return copy_schema
