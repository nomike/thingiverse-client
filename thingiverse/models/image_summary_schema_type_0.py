...
T = TypeVar("T", bound="ImageSummarySchemaType0")


@_attrs_define
class ImageSummarySchemaType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_summary_schema_type_0 = cls(
            added=added,
            id=id,
            name=name,
            sizes=sizes,
        ...
        image_summary_schema_type_0.additional_properties = d
        return image_summary_schema_type_0
