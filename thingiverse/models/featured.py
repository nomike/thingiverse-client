...
class Featured:
    ...
    Attributes:
        ...
        rank (int | Unset):
        spotlight_images (FeaturedSpotlightImages | Unset):
    ...
    spotlight_images: FeaturedSpotlightImages | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_spotlight_images, Unset):
            ...
            spotlight_images = FeaturedSpotlightImages.from_dict(_spotlight_images)
        ...
        featured.additional_properties = d
        return featured
