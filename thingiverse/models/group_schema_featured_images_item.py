...
T = TypeVar("T", bound="GroupSchemaFeaturedImagesItem")


@_attrs_define
class GroupSchemaFeaturedImagesItem:
    """
    Attributes:
        url_image (str | Unset):
        url_thing (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_schema_featured_images_item = cls(
            url_image=url_image,
            url_thing=url_thing,
        )

        group_schema_featured_images_item.additional_properties = d
        return group_schema_featured_images_item
