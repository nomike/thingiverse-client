...
T = TypeVar("T", bound="GetUsersUsernameStatsByDayStartDateEndDateResponse200Item")


@_attrs_define
class GetUsersUsernameStatsByDayStartDateEndDateResponse200Item:
    """
    Attributes:
        collects (int | Unset):
        comments (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_username_stats_by_day_start_date_end_date_response_200_item = cls(
            collects=collects,
            comments=comments,
            day=day,
        ...
        get_users_username_stats_by_day_start_date_end_date_response_200_item.additional_properties = d
        return get_users_username_stats_by_day_start_date_end_date_response_200_item
