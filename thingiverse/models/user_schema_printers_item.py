...
T = TypeVar("T", bound="UserSchemaPrintersItem")


@_attrs_define
class UserSchemaPrintersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_schema_printers_item = cls(
            id=id,
            name=name,
            public_url=public_url,
        )

        user_schema_printers_item.additional_properties = d
        return user_schema_printers_item
