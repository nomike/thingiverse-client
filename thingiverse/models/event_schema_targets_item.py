...
T = TypeVar("T", bound="EventSchemaTargetsItem")


@_attrs_define
class EventSchemaTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_schema_targets_item = cls(
            default_image=default_image,
            things_url=things_url,
            thumbnail=thumbnail,
        )

        event_schema_targets_item.additional_properties = d
        return event_schema_targets_item
