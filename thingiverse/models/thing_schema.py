...
class ThingSchema:
    ...
    Attributes:
        ...
        ancestors (list[ThingSchemaAncestorsItem] | Unset):
        ...
        description_html (str | Unset):  Example: <div><p><a rel=\"ugc nofollow\"
            ...
            rendering.</p></div>.
        details (str | Unset):
        details_parts (list[ThingSchemaDetailsPartsItem] | Unset):
        download_count (int | Unset):  Example: 3169879.
        edu_details (str | Unset):
        edu_details_parts (list[ThingSchemaEduDetailsPartsType0Item] | None | Unset):
        education (ThingSchemaEducation | Unset):
        ...
        zip_data (ThingSchemaZipData | Unset):
    """
    ...
    ancestors: list[ThingSchemaAncestorsItem] | Unset = UNSET
    ...
    details_parts: list[ThingSchemaDetailsPartsItem] | Unset = UNSET
    download_count: int | Unset = UNSET
    edu_details: str | Unset = UNSET
    edu_details_parts: list[ThingSchemaEduDetailsPartsType0Item] | None | Unset = UNSET
    education: ThingSchemaEducation | Unset = UNSET
    ...
    zip_data: ThingSchemaZipData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ancestors is not UNSET:
            ...
            for ancestors_item_data in _ancestors:
                ancestors_item = ThingSchemaAncestorsItem.from_dict(ancestors_item_data)
        ...
        if _details_parts is not UNSET:
            ...
            for details_parts_item_data in _details_parts:
                details_parts_item = ThingSchemaDetailsPartsItem.from_dict(details_parts_item_data)
        ...
        def _parse_edu_details_parts(
            ...
            try:
                ...
                for edu_details_parts_type_0_item_data in _edu_details_parts_type_0:
                    edu_details_parts_type_0_item = ThingSchemaEduDetailsPartsType0Item.from_dict(
                ...
                pass
            return cast(list[ThingSchemaEduDetailsPartsType0Item] | None | Unset, data)
        ...
        if isinstance(_education, Unset):
            ...
            education = ThingSchemaEducation.from_dict(_education)
        ...
        if isinstance(_zip_data, Unset):
            ...
            zip_data = ThingSchemaZipData.from_dict(_zip_data)
        ...
        thing_schema.additional_properties = d
        return thing_schema
