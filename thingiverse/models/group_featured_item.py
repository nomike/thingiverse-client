...
if TYPE_CHECKING:
    from ..models.group_featured_item_tags_item import GroupFeaturedItemTagsItem
    from ..models.user_summary_schema_type_0 import UserSummarySchemaType0


T = TypeVar("T", bound="GroupFeaturedItem")


@_attrs_define
class GroupFeaturedItem:
    """
    Attributes:
        ...
        tags (list[GroupFeaturedItemTagsItem] | Unset):
        thumbnail (str | Unset):
        url (str | Unset):
    """
    ...
    tags: list[GroupFeaturedItemTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _tags is not UNSET:
            ...
            for tags_item_data in _tags:
                tags_item = GroupFeaturedItemTagsItem.from_dict(tags_item_data)
        ...
        group_featured_item.additional_properties = d
        return group_featured_item
