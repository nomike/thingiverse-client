...
T = TypeVar("T", bound="EventSchemaSourcesItemType0")


@_attrs_define
class EventSchemaSourcesItemType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_schema_sources_item_type_0 = cls(
            default_image=default_image,
            thumbnail=thumbnail,
        )

        event_schema_sources_item_type_0.additional_properties = d
        return event_schema_sources_item_type_0
