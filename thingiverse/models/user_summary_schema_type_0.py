...
T = TypeVar("T", bound="UserSummarySchemaType0")


@_attrs_define
class UserSummarySchemaType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_summary_schema_type_0 = cls(
        ...
        user_summary_schema_type_0.additional_properties = d
        return user_summary_schema_type_0
