...
T = TypeVar("T", bound="PostThingopsIdsCopyBody")


@_attrs_define
class PostThingopsIdsCopyBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_thingops_ids_copy_body = cls(
            source_collection_id=source_collection_id,
            target_collection_id=target_collection_id,
        )

        post_thingops_ids_copy_body.additional_properties = d
        return post_thingops_ids_copy_body
