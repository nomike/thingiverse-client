...
from ...models.get_tags_0_popular_response_401 import GetTags0PopularResponse401
from ...models.get_tags_0_popular_response_403 import GetTags0PopularResponse403
from ...models.get_tags_0_popular_response_404 import GetTags0PopularResponse404
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetTags0PopularResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetTags0PopularResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetTags0PopularResponse404.from_dict(response.json())
