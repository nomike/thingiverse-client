...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/subscriptions/0/dashboard-sources",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetSubscriptions0DashboardSourcesResponse200.from_dict(response.json())

        return response_200

    if response.status_code == 401:
        response_401 = GetSubscriptions0DashboardSourcesResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetSubscriptions0DashboardSourcesResponse403.from_dict(response.json())
