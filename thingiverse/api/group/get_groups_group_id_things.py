...
from ...models.get_groups_group_id_things_response_401 import GetGroupsGroupIdThingsResponse401
from ...models.get_groups_group_id_things_response_403 import GetGroupsGroupIdThingsResponse403
from ...models.get_groups_group_id_things_response_404 import GetGroupsGroupIdThingsResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/groups/{group_id}/things".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetGroupsGroupIdThingsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetGroupsGroupIdThingsResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetGroupsGroupIdThingsResponse404.from_dict(response.json())
