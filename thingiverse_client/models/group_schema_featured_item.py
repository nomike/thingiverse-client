...
if TYPE_CHECKING:
    from ..models.group_schema_featured_item_tags_item import GroupSchemaFeaturedItemTagsItem
    from ..models.user_summary_schema_type_0 import UserSummarySchemaType0


T = TypeVar("T", bound="GroupSchemaFeaturedItem")


@_attrs_define
class GroupSchemaFeaturedItem:
    """
    Attributes:
        ...
        tags (list[GroupSchemaFeaturedItemTagsItem] | Unset):
        thumbnail (str | Unset):
        url (str | Unset):
    """
    ...
    tags: list[GroupSchemaFeaturedItemTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _tags is not UNSET:
            ...
            for tags_item_data in _tags:
                tags_item = GroupSchemaFeaturedItemTagsItem.from_dict(tags_item_data)
        ...
        group_schema_featured_item = cls(
        ...
        group_schema_featured_item.additional_properties = d
        return group_schema_featured_item
