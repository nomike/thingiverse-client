...
if TYPE_CHECKING:
    ...
    from ..models.grouptopic_schema_comments import GrouptopicSchemaComments
    from ..models.grouptopic_schema_tags import GrouptopicSchemaTags
    from ..models.member_schema import MemberSchema


T = TypeVar("T", bound="GrouptopicSchema")


@_attrs_define
class GrouptopicSchema:
    """
    Attributes:
        id (int):
        ...
        comments (GrouptopicSchemaComments | Unset):
        group_url (str | Unset):
        ...
        tags (GrouptopicSchemaTags | Unset):
        type_name (str | Unset):
        url (str | Unset):
    ...
    comments: GrouptopicSchemaComments | Unset = UNSET
    ...
    tags: GrouptopicSchemaTags | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comments, Unset):
            ...
            comments = GrouptopicSchemaComments.from_dict(_comments)
        ...
        if isinstance(_tags, Unset):
            ...
            tags = GrouptopicSchemaTags.from_dict(_tags)
        ...
        grouptopic_schema.additional_properties = d
        return grouptopic_schema
