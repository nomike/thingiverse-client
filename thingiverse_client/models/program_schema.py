...
if TYPE_CHECKING:
    from ..models.program_schema_body import ProgramSchemaBody
...
class ProgramSchema:
    """
    Attributes:
        body (ProgramSchemaBody | Unset):
    """

    body: ProgramSchemaBody | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_body, Unset):
            ...
            body = ProgramSchemaBody.from_dict(_body)
