...
T = TypeVar("T", bound="SitewidenotificationSchemaType0")


@_attrs_define
class SitewidenotificationSchemaType0:
    """
    Attributes:
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sitewidenotification_schema_type_0 = cls(
            id=id,
        ...
        sitewidenotification_schema_type_0.additional_properties = d
        return sitewidenotification_schema_type_0
