...
if TYPE_CHECKING:
    from ..models.user_groups_item import UserGroupsItem
    from ..models.user_printers_item import UserPrintersItem
    from ..models.user_programs_item import UserProgramsItem
    from ..models.user_twitter_type_0 import UserTwitterType0
    from ..models.user_types_item import UserTypesItem
...
class User:
    ...
    Attributes:
        ...
        groups (list[UserGroupsItem] | Unset):
        ...
        printers (list[UserPrintersItem] | Unset):
        programs (list[UserProgramsItem] | Unset):
        ...
        twitter (None | Unset | UserTwitterType0):
        types (list[UserTypesItem] | Unset):
    ...
    groups: list[UserGroupsItem] | Unset = UNSET
    ...
    printers: list[UserPrintersItem] | Unset = UNSET
    programs: list[UserProgramsItem] | Unset = UNSET
    ...
    twitter: None | Unset | UserTwitterType0 = UNSET
    types: list[UserTypesItem] | Unset = UNSET
    url: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.twitter, Unset):
            twitter = UNSET
        elif isinstance(self.twitter, UserTwitterType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = UserGroupsItem.from_dict(groups_item_data)
        ...
        if _printers is not UNSET:
            ...
            for printers_item_data in _printers:
                printers_item = UserPrintersItem.from_dict(printers_item_data)
        ...
        if _programs is not UNSET:
            ...
            for programs_item_data in _programs:
                programs_item = UserProgramsItem.from_dict(programs_item_data)
        ...
        def _parse_twitter(data: object) -> None | Unset | UserTwitterType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                twitter_type_0 = UserTwitterType0.from_dict(data)

                return twitter_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserTwitterType0, data)
        ...
        if _types is not UNSET:
            ...
            for types_item_data in _types:
                types_item = UserTypesItem.from_dict(types_item_data)
