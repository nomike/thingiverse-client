...
T = TypeVar("T", bound="UserSchemaTwitterType0")


@_attrs_define
class UserSchemaTwitterType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_schema_twitter_type_0 = cls(
            account_name=account_name,
            account_url=account_url,
        )

        user_schema_twitter_type_0.additional_properties = d
        return user_schema_twitter_type_0
