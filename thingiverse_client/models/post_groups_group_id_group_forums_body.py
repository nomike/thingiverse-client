...
T = TypeVar("T", bound="PostGroupsGroupIdGroupForumsBody")


@_attrs_define
class PostGroupsGroupIdGroupForumsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_group_id_group_forums_body = cls(
            description=description,
            name=name,
            file=file,
            filename=filename,
        ...
        post_groups_group_id_group_forums_body.additional_properties = d
        return post_groups_group_id_group_forums_body
