...
if TYPE_CHECKING:
    from ..models.comment_attachments_item import CommentAttachmentsItem
...
class Comment:
    ...
    attachments: list[CommentAttachmentsItem] | Unset = UNSET
    ...
    target_type: CommentTargetType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _attachments is not UNSET:
            ...
            for attachments_item_data in _attachments:
                attachments_item = CommentAttachmentsItem.from_dict(attachments_item_data)
        ...
        if isinstance(_target_type, Unset):
            ...
            target_type = CommentTargetType(_target_type)
