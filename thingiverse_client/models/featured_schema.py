...
if TYPE_CHECKING:
    from ..models.featured_schema_spotlight_images import FeaturedSchemaSpotlightImages
    from ..models.tag_schema import TagSchema
    from ..models.user_summary_schema_type_0 import UserSummarySchemaType0


T = TypeVar("T", bound="FeaturedSchema")
...
class FeaturedSchema:
    ...
    Attributes:
        ...
        rank (int | Unset):
        spotlight_images (FeaturedSchemaSpotlightImages | Unset):
    ...
    spotlight_images: FeaturedSchemaSpotlightImages | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        spotlight_images: dict[str, Any] | Unset = UNSET
        if not isinstance(self.spotlight_images, Unset):
            spotlight_images = self.spotlight_images.to_dict()
        ...
        if spotlight_images is not UNSET:
            field_dict["spotlight_images"] = spotlight_images
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _spotlight_images = d.pop("spotlight_images", UNSET)
        spotlight_images: FeaturedSchemaSpotlightImages | Unset
        if isinstance(_spotlight_images, Unset):
            spotlight_images = UNSET
        else:
            spotlight_images = FeaturedSchemaSpotlightImages.from_dict(_spotlight_images)
        ...
        featured_schema = cls(
            ...
            rank=rank,
            spotlight_images=spotlight_images,
            tags=tags,
            thumbnail=thumbnail,
            url=url,
        )

        featured_schema.additional_properties = d
        return featured_schema
