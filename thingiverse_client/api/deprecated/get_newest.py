...
from ...models.get_newest_response_401 import GetNewestResponse401
from ...models.get_newest_response_403 import GetNewestResponse403
from ...models.get_newest_response_404 import GetNewestResponse404
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetNewestResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetNewestResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetNewestResponse404.from_dict(response.json())
