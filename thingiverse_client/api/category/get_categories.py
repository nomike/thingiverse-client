...
from ...models.get_categories_response_200_item import GetCategoriesResponse200Item
...
from ...models.get_categories_response_404 import GetCategoriesResponse404
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetCategoriesResponse200Item.from_dict(response_200_item_data)
    ...
    if response.status_code == 404:
        response_404 = GetCategoriesResponse404.from_dict(response.json())
