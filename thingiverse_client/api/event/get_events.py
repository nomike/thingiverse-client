...
from ...models.get_events_response_401 import GetEventsResponse401
from ...models.get_events_response_403 import GetEventsResponse403
from ...models.get_events_response_404 import GetEventsResponse404
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetEventsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetEventsResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetEventsResponse404.from_dict(response.json())
