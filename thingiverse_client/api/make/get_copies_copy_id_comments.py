...
from ...models.get_copies_copy_id_comments_response_401 import GetCopiesCopyIdCommentsResponse401
from ...models.get_copies_copy_id_comments_response_403 import GetCopiesCopyIdCommentsResponse403
from ...models.get_copies_copy_id_comments_response_404 import GetCopiesCopyIdCommentsResponse404
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetCopiesCopyIdCommentsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetCopiesCopyIdCommentsResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetCopiesCopyIdCommentsResponse404.from_dict(response.json())
