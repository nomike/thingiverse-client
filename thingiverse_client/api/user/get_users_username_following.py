...
from ...models.get_users_username_following_response_401 import GetUsersUsernameFollowingResponse401
from ...models.get_users_username_following_response_403 import GetUsersUsernameFollowingResponse403
from ...models.get_users_username_following_response_404 import GetUsersUsernameFollowingResponse404
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{username}/following".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetUsersUsernameFollowingResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetUsersUsernameFollowingResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetUsersUsernameFollowingResponse404.from_dict(response.json())
