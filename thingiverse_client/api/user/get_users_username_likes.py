...
from ...models.get_users_username_likes_response_401 import GetUsersUsernameLikesResponse401
from ...models.get_users_username_likes_response_403 import GetUsersUsernameLikesResponse403
from ...models.get_users_username_likes_response_404 import GetUsersUsernameLikesResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{username}/likes".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetUsersUsernameLikesResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetUsersUsernameLikesResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetUsersUsernameLikesResponse404.from_dict(response.json())
