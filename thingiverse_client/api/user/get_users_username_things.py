...
from ...models.get_users_username_things_response_401 import GetUsersUsernameThingsResponse401
from ...models.get_users_username_things_response_403 import GetUsersUsernameThingsResponse403
from ...models.get_users_username_things_response_404 import GetUsersUsernameThingsResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{username}/things".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetUsersUsernameThingsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetUsersUsernameThingsResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetUsersUsernameThingsResponse404.from_dict(response.json())
