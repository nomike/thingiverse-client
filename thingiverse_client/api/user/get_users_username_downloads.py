...
from ...models.get_users_username_downloads_response_401 import GetUsersUsernameDownloadsResponse401
from ...models.get_users_username_downloads_response_403 import GetUsersUsernameDownloadsResponse403
from ...models.get_users_username_downloads_response_404 import GetUsersUsernameDownloadsResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{username}/downloads".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetUsersUsernameDownloadsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetUsersUsernameDownloadsResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetUsersUsernameDownloadsResponse404.from_dict(response.json())
