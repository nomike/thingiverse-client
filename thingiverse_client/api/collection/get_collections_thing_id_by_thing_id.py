...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/collections/{thing_id}/by-thing-id".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = GetCollectionsThingIdByThingIdResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = GetCollectionsThingIdByThingIdResponse403.from_dict(response.json())

        return response_403

    if response.status_code == 404:
        response_404 = GetCollectionsThingIdByThingIdResponse404.from_dict(response.json())
